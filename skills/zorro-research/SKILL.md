...
2. **抓取**：`python3 ~/.hermes/scripts/x_scrape.py <推文URL>`
3. **批量下载**：`python3 ~/.hermes/scripts/x_batch_download.py <URL1> <URL2> ...`
...
**来源B — 已知高质量账号（搜索主页）：**
`@dotey、@tychozzz、@Khazix0918、@kevingu_ai、@niceplugin、@leopardracer`
